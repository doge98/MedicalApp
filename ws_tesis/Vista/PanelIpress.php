...
<head>
    ...
    <body>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h4>Informaci&oacute;n de La IPRESS</h4> 
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    <fieldset disabled>
                                        <input type="text" id="nombrecomercial" name="nombrecomercial" class="form-control form-control-sm">
                                    </fieldset>
                                </div>
                                <div class="col-md-auto">
                                    <p class="font-weight-light">C&oacute;digo IPRESS:</p>
                                </div>
                                <div class="col-md-auto">
                                    <fieldset disabled>
                                        <input type="text" id="codigounicoipress" name="nombrecomercial" class="form-control form-control-sm">
                                    </fieldset>
                                </div>
                                <div class="col-md-auto">
                            ...
                            <div class="row">
                                <div class="col-md-auto">
                                    <p class="font-weight-light">Representante legal:</p>
                                </div>
                                <div class="col">
                                    <fieldset disabled>
                                        <input type="text" id="representantelegal" name="representantelegal" class="form-control form-control-sm">
                                    </fieldset>
                                </div>
                                <div class="col-md-auto">
                                    <p class="font-weight-light">Documento de identidad:</p>
                                </div>
                                <div class="col">
                                    <fieldset disabled>
                                        <input type="text" id="documentoidentidad" name="documentoidentidad" class="form-control form-control-sm">
                                    </fieldset>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-auto">
                                    <p class="font-weight-light">Tel&eacute;fono / Tel&eacute;fono de Emergencia:</p>
                                </div>
                                <div class="col">
                                    <fieldset disabled>
                                ...
                                <div class="col-md-auto">
                                    <fieldset disabled>
                                        <input type="text" id="latitud" name="latitud" class="form-control form-control-sm">
                                    </fieldset>
                                </div>
                                <div class="col-md-auto">
                                ...
                                <div class="col-md-auto">
                                    <fieldset disabled>
                                        <input type="text" id="longitud" name="longitud" class="form-control form-control-sm">
                                    </fieldset>
                                </div>
                            </div>
                            <br>
                            <div class="col">
                                <p class="font-weight-light"><strong>Unidades prestadores de salud del establecimiento:</strong></p>
                            </div>
                            <div class="col">
                                <div id="tablaups"></div>
                            </div>
    ...
    <script>
        ipressver('<?php echo $codigo_ipress ?>');
